...
SetupIconFile=C:\Users\Administrator\Desktop\C盘安心管家发布版\C盘安心管家-v1.2\assets\app-icon.ico
...
[Icons]
Name: "{autodesktop}\C盘安心管家"; Filename: "{cmd}"; Parameters: "/c start """" wscript ""{app}\launch.vbs"""; WorkingDir: "{app}"; IconFilename: "{app}\assets\app-icon.ico"
Name: "{group}\C盘安心管家"; Filename: "{cmd}"; Parameters: "/c start """" wscript ""{app}\launch.vbs"""; WorkingDir: "{app}"; IconFilename: "{app}\assets\app-icon.ico"

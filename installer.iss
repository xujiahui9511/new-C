...
[Icons]
Name: "{autodesktop}\C盘安心管家"; Filename: "{cmd}"; Parameters: "/c start """" wscript ""{app}\launch.vbs"""; WorkingDir: "{app}"; IconFilename: "{sys}\cleanmgr.exe"
Name: "{group}\C盘安心管家"; Filename: "{cmd}"; Parameters: "/c start """" wscript ""{app}\launch.vbs"""; WorkingDir: "{app}"; IconFilename: "{sys}\cleanmgr.exe"

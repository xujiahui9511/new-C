...
[Icons]
Name: "{autodesktop}\C盘安心管家"; Filename: "{app}\启动C盘安心管家.cmd"; WorkingDir: "{app}"; IconFilename: "{sys}\cleanmgr.exe"
Name: "{group}\C盘安心管家"; Filename: "{app}\启动C盘安心管家.cmd"; WorkingDir: "{app}"; IconFilename: "{sys}\cleanmgr.exe"
Name: "{group}\卸载C盘安心管家"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\启动C盘安心管家.cmd"; Description: "启动 C盘安心管家"; Flags: nowait postinstall skipifsilent
